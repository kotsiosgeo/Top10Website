  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="jumbotron">
            <h1 class="display-4">Top 10 Museums in Limassol:</h1>
            <p class="lead">These are the top 10 Museums in Limassol according to our user's ratings!</p>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-8">
          ...
          <div class="post">
            <h2> #2 </h2>
            <hr>
            <img src="http://localhost/dashboard/test/Top10website/public/uploads/destinations/limassolcastle.jpg" width="250" height="150" align="left" style="margin-right:10px">
          ...
          <div class="post">
            <h2> #3 </h2>
            <hr>
            <img src="http://localhost/dashboard/test/Top10website/public/uploads/destinations/carobmill.jpg" width="250" height="150" align="left" style="margin-right:10px">
          ...
          <div class="post">
            <h2> #4 </h2>
            <hr>
            <img src="http://localhost/dashboard/test/Top10website/public/uploads/destinations/limassolarchaeologicalmuseum.jpg" width="250" height="150" align="left" style="margin-right:10px">
          ...
          <div class="post">
            <h2> #5 </h2>
            <hr>
            <img src="http://localhost/dashboard/test/Top10website/public/uploads/destinations/ploumistopsomi.jpg" width="250" height="150" align="left" style="margin-right:10px">
          ...
          <div class="post">
            <h2> #6 </h2>
            <hr>
            <img src="http://localhost/dashboard/test/Top10website/public/uploads/destinations/katiesabry.jpg" width="250" height="150" align="left" style="margin-right:10px">
          ...
          <div class="post">
            <h2> #7 </h2>
            <hr>
            <img src="http://localhost/dashboard/test/Top10website/public/uploads/destinations/watermuseum.jpg" width="250" height="150" align="left" style="margin-right:10px">
          ...
          <div class="post">
            <h2> #8 </h2>
            <hr>
            <img src="http://localhost/dashboard/test/Top10website/public/uploads/destinations/limassolartgallery.jpg" width="250" height="150" align="left" style="margin-right:10px">
          ...
          <div class="post">
            <h2> #9 </h2>
            <hr>
            <img src="http://localhost/dashboard/test/Top10website/public/uploads/destinations/nocturnegallery.jpg" width="250" height="150" align="left" style="margin-right:10px">
          ...
          <div class="post">
            <h2> #10 </h2>
            <hr>
            <img src="http://localhost/dashboard/test/Top10website/public/uploads/destinations/limassoltheatermuseum.jpg" width="250" height="150" align="left" style="margin-right:10px">
