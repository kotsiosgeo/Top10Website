      ...
      <div class="row">
        <div class="col-md-8">
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/54') }}"><h4>Cyprus Historic & Classic Motor Museum</h4></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/55') }}"><h2>Limassol Castle</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/56') }}"><h2>Carob Mill Museum</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/57') }}"><h3>Limassol Archaeological Museum</h3></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/58') }}"><h2>Ploumisto Psomi Museum</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/59') }}"><h2>Katie Sabry Studio</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/60') }}"><h2>Water Museum</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/61') }}"><h3>Limassol Municipal Art Gallery</h3></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/62') }}"><h2>Nocturne Gallery</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/63') }}"><h2>Cyprus Theater Museum</h2></a>
