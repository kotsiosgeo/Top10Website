      ...
      <div class="row">
        <div class="col-md-8">
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/2') }}"><h2>Ammos Beach Bar</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/4') }}"><h3>Secret Garden Wine & Coffee Bar</h3></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/5') }}"><h2>Rum Tree</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/6') }}"><h2>Club Deep</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/7') }}"><h2>Skylight Music Bar</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/8') }}"><h2>Blue Martini Summer Club</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/9') }}"><h2>Fini's Beach Bar</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/10') }}"><h2>The Belfry Larnaca</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/11') }}"><h2>Kokomo Music Bar</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/12') }}"><h2>Barcode</h2></a>
