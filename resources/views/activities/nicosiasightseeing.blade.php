      ...
      <div class="row">
        <div class="col-md-8">
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/114') }}"><h2>Machairas Monastery</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/115') }}"><h2>Ledra Street Crossing Point</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/116') }}"><h2>Famagusta Gate</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/117') }}"><h3>Venetian walls of Nicosia</h3></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/118') }}"><h2>The Medieval Walls of Nicosia</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/119') }}"><h5>Sacred Temple of Virgin Mary Faneromenis</h5></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/120') }}"><h2>Panagia Asinou Church</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/121') }}"><h4>Liberty Monument</h4></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/122') }}"><h4>Archbishop Makarios III Monument</h4></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/123') }}"><h2>Archbishop’s Palace</h2></a>
