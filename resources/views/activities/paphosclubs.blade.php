      ...
      <div class="row">
        <div class="col-md-8">
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/124') }}"><h2>Loft Club</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/125') }}"><h2>First & Last Bar Paphos</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/126') }}"><h2>Flairs Cocktail Bar</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/127') }}"><h2>Summer Club</h2></a>
            <p>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/128') }}"><h5>The Old Fishing Shack Ale & Cider House</h5></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/129') }}"><h2>Flintstones Bar</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/130') }}"><h2>The Bottle Bank Bar</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/131') }}"><h2>The Wooden Pub</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/132') }}"><h2>The Rose Pub Cyprus</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/133') }}"><h2>Different Bar</h2></a>
