      ...
      <div class="row">
        <div class="col-md-8">
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('/profile') }}"><h4>Leventis Municipal Museum of Nicosia</h4></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('/profile') }}"><h2>Cyprus Museum</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('/profile') }}"><h4>Shacolas Tower Museum & Observatory</h4></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('/profile') }}"><h3>Centre of Visual Arts and Research</h3></a>
            <p>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('/profile') }}"><h2>Cyprus Folk Art Museum</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('/profile') }}"><h3>The National Struggle Museum</h3></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('/profile') }}"><h4>Cyprus Classic Motorcycle Museum</h4></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('/profile') }}"><h3>A. G. Leventis Gallery</h3></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('/profile') }}"><h2>Postal Museum</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('/profile') }}"><h4>The Pancyprian Gymnasium Museums</h4></a>
