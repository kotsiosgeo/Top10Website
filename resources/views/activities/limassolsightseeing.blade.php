      ...
      <div class="row">
        <div class="col-md-8">
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/74') }}"><h2>Kourion</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/75') }}"><h2>Omodos Village</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/76') }}"><h2>Limassol Marina</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/77') }}"><h3>Fasouri Watermania Water Park</h3></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/78') }}"><h2>Limassol Promenade</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/79') }}"><h3>Caledonia Waterfalls (Kalidonia)</h3></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/80') }}"><h2>Kourion Beach</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/81') }}"><h4>Cyprus Historic & Classic Motor Museum</h4></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/82') }}"><h2>Limassol Zoo</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/83') }}"><h2>The Sanctuary of Apollo</h2></a>
