      ...
      <div class="row">
        <div class="col-md-8">
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/154') }}"><h3>Kato Paphos Archaeological Park</h3></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/155') }}"><h2>Paphos Harbour and Port</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/156') }}"><h4>Aphrodite's Rock Brewing Company</h4></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/157') }}"><h2>Tombs of the Kings</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/158') }}"><h2>Agios Neophytos Monastery</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/159') }}"><h5>Horse Riding Paphos-Eagle Mountain Ranch</h5></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/160') }}"><h2>Avakas Gorge</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/161') }}"><h2>The House of Dionysus</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/162') }}"><h2>Paphos Aphrodite Waterpark</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/163') }}"><h2>Paphos Zoo</h2></a>
