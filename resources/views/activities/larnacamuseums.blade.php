      ...
      <div class="row">
        <div class="col-md-8">
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ URL::to('destinations/13') }}"><h2>Larnaca Medieval Castle</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/14') }}"><h2>Every Day is a Gift</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/15') }}"><h2>Pierides Museum</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/16') }}"><h3>Kyriazis Medical Museum</h3></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/17') }}"><h2>Larnaca Municipal Art Gallery</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/18') }}"><h4>Kallinikeio Municipal Museum Athienou</h4></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/19') }}"><h4>Larnaka District Archaeological Museum</h4></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/20') }}"><h2>The House of Platini</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/21') }}"><h4>Municipal Museum of Natural History</h4></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/22') }}"><h2>The Salt & Pepper Museum</h2></a>
