      ...
      <div class="row">
        <div class="col-md-8">
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/84') }}"><h2>Lost + Found Drinkery</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/85') }}"><h2>State Club</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/86') }}"><h2>Pyxida Oyster Bar</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/87') }}"><h2>Wine and More</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/88') }}"><h2>The Apartment Club</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/89') }}"><h2>Plato's Bar</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/90') }}"><h2>Brewfellas Beer Bar</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/91') }}"><h2>Klubd</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/92') }}"><h2>MO Club</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/93') }}"><h2>Silver Star Wine Bar</h2></a>
