      ...
      <div class="row">
        <div class="col-md-8">
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/44') }}"><h2>Guaba Beach Bar</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/45') }}"><h2>7 Seas</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/46') }}"><h2>Ravens Music Hall</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/47') }}"><h2>Breeze Summer Club</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/48') }}"><h2>Marina Roof Bar</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/49') }}"><h2>Dolce Club</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/50') }}"><h2>Poe Bar</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/51') }}"><h2>Daltons Bar</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/52') }}"><h2>Rogmes Live Music</h2></a>
          ...
          <div class="post">
            ...
            <a class="btn btn-link" href="{{ url('destinations/53') }}"><h2>HookahPlace Limassol</h2></a>
